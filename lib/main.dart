...
class _HomeState extends State<Home> {
    ...
    String calc(String string){
        ...
        i = 1;
        while ((listString.contains('X') || listString.contains('÷'))&& i < listString.length){
            if (listString[i] == 'X'){
                double f1 = double.parse(listString.removeAt(i-1));
                listString.removeAt(i-1);
                double f2 = double.parse(listString.removeAt(i-1));
        ...
        i = 1;
        while ((listString.contains('+') || listString.contains('-'))&& i < listString.length){
            if (listString[i] == '+'){
                double f1 = double.parse(listString.removeAt(i-1));
                listString.removeAt(i-1);
                double f2 = double.parse(listString.removeAt(i-1));
    ...
    Container myContainer({String text, double width=0.25, Color bg= Colors.white70, callback=false}) {
        if (callback == false){
            callback = () {click(text);};
        }
        return Container(
                ...
                children: <Widget>[
                    ...
                    Row(
                        children: <Widget>[
                            ...
                            myContainer(text: "xʸ", bg: Colors.green, callback: () {click(" ^ ");}),
